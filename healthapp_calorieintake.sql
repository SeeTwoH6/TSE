...
CREATE TABLE `calorieintake` (
  ...
  `Date` date NOT NULL,
  `CalorieUserID` int NOT NULL,
  PRIMARY KEY (`CalorieIntakeID`),
  KEY `CalorieUserID_idx` (`CalorieUserID`),
  CONSTRAINT `CalorieUserID` FOREIGN KEY (`CalorieUserID`) REFERENCES `users` (`UserID`)
