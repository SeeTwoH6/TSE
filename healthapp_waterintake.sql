...
CREATE TABLE `waterintake` (
  `WaterIntakeID` int NOT NULL,
  `UserID` int NOT NULL,
  `Date` date NOT NULL,
  `WaterAmount` varchar(45) NOT NULL,
  PRIMARY KEY (`WaterIntakeID`),
...
LOCK TABLES `waterintake` WRITE;
/*!40000 ALTER TABLE `waterintake` DISABLE KEYS */;
/*!40000 ALTER TABLE `waterintake` ENABLE KEYS */;
UNLOCK TABLES;
